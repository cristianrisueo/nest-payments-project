...
import { PaymentRepositoryInterface } from '../../domain/repositories/payment.repository';
...
export class PaymentRepository implements PaymentRepositoryInterface {
  ...
  async save(payment: Payment): Promise<void> {
    try {
      const paymentDocument = new this.paymentModel({
        ...
        paymentMethodLastFour: payment.paymentMethod.lastFourDigits,
  ...
  /**
   * Helper that maps a MongoDB document to a Payment domain entity.
  ...
  private mapDocumentToPayment(document: PaymentDocument): Payment {
    return Payment.createFromDatabase(
      ...
      document.paymentMethodType,
      document.paymentMethodLastFour,
      document.status,
